...
# OBS Full Clone Tool v1.3.2 - Create backup
...
try {
    Write-Info "=== OBS FULL CLONE v1.3.2: СОЗДАНИЕ BACKUP ==="
    ...
    $sourceMapLines = @(
        "OBS FULL CLONE v1.3.2 - SOURCE MAP",
    ...
    @(
        "OBS FULL CLONE v1.3.2 - REMOTE DEPENDENCIES",
        "",
...
"@ |
    ...
    $runtimeAudit = @"
OBS FULL CLONE v1.3.2 - RUNTIME AUDIT
===================================
